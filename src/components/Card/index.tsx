    ...
    <Link to={`/${props.id}`}>
      <div className="w-full max-w-sm mx-auto shadow border rounded-lg overflow-hidden">
        ...
        <div className="w-full  my-3 px-3 flex justify-end">
          <button className="hover:shadow hover:bg-indigo-500 hover:text-white transition-all duration-100  bg-gray-300 rounded text-sm px-4 py-2 mr-2 text-gray-700 font-bold w-full">
            Αγόρα Τώρα
          </button>
          <button className="hover:shadow transition-shadow bg-gray-300 rounded px-4 py-2 mr-2">
          ...
          <button
            ...
            className="hover:shadow transition-shadow bg-gray-300 rounded px-4 py-2"
          >
