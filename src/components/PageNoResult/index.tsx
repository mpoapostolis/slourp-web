...
export default function PageNoResult() {
  return (
    <div className="h-full w-full bg-gray-100 flex items-center">
      <div className="flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div className="max-w-md">
          <div className="text-5xl font-dark font-bold">Hello user</div>
          <p className="text-2xl md:text-3xl font-light leading-normal">
            Sorry we couldn't find any product.{" "}
          </p>
          <p className="mb-8">
            But dont worry, you can find plenty of other things try different
            filter.
          </p>
        </div>
